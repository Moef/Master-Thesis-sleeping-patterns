...
This chapter is about our data collection. We collected data from November 2015 to mid July 2016. We split the data collection into two periods; experiment 1 and experiment 2. The first experiment run from when the participant starts through March 2016, and the second run from April 1, 2016 to July 15, 2016 when the data collection ended. \\

We analysed experiment 1 first to learn, and used our algorithms on the data from experiment 2 to check up on our results. 
