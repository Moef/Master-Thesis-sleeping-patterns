...
- ``Consumer sleep tracking devices: a review ofmechanisms, validity and utility''\\
...
ALSO: ADD SOMETHING ABOUT THIS PAPER - ``A Global Quantification of `normal' Sleep Schedules Using Smartphone data''\\
...
\begin{footnotesize}
	...
	September 2016 & \\
	October 2016 & \\
	November 2016 & Hand in on November ??\\
	\hline
	\end{tabular}
...
\begin{figure}[H]
 \centering 
 \includepdf[pages=1,scale=0.9, pagecommand={}]{pdf/udsnit-basisretriever.pdf}
\end{figure}
